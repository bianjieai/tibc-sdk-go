...
import (
	...
	packet "github.com/bianjieai/tibc-sdk-go/packet"
...
type GenesisState struct {
	...
	ClientGenesis client.GenesisState `protobuf:"bytes,1,opt,name=client_genesis,json=clientGenesis,proto3" json:"client_genesis" yaml:"client_genesis"`
	// ICS004 - Packet genesis state
	PacketGenesis packet.GenesisState `protobuf:"bytes,3,opt,name=packet_genesis,json=packetGenesis,proto3" json:"packet_genesis" yaml:"packet_genesis"`
}
...
func (m *GenesisState) GetClientGenesis() client.GenesisState {
	if m != nil {
		return m.ClientGenesis
	}
	return client.GenesisState{}
}

func (m *GenesisState) GetPacketGenesis() packet.GenesisState {
	if m != nil {
		return m.PacketGenesis
	}
	return packet.GenesisState{}
}
...
var fileDescriptor_7379bcbeb8a4fd03 = []byte{
	...
	0x82, 0x78, 0x21, 0x02, 0x50, 0x2d, 0x4e, 0x0e, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7,
	0xf8, 0xe0, 0x91, 0x1c, 0xe3, 0x84, 0xc7, 0x72, 0x0c, 0x17, 0x1e, 0xcb, 0x31, 0xdc, 0x78, 0x2c,
	0xc7, 0x10, 0xa5, 0x96, 0x9e, 0x59, 0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x9f, 0x94,
	0x99, 0x98, 0x97, 0x95, 0x99, 0x9a, 0x98, 0xa9, 0x0f, 0xb2, 0x5e, 0xb7, 0x38, 0x25, 0x5b, 0x37,
	0x3d, 0x1f, 0x12, 0x4b, 0x49, 0x6c, 0xe0, 0xb0, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x7b,
	0xc7, 0x7f, 0x4a, 0xbf, 0x01, 0x00, 0x00,
}
